...
def load_arguments(self, _):
    ...
    with self.argument_context('appconfigdev') as c:
    ...
    with self.argument_context('appconfigdev create') as c:
    ...
    with self.argument_context('appconfigdev update') as c:
    ...
    with self.argument_context('appconfigdev recover') as c:
    ...
    with self.argument_context('appconfigdev show-deleted') as c:
        c.argument('location', arg_type=get_location_type(self.cli_ctx), help='Location of the deleted App Configuration.')

    with self.argument_context('appconfigdev purge') as c:
        c.argument('location', arg_type=get_location_type(self.cli_ctx), help='Location of the deleted App Configuration. Can be viewed using command `az appconfig show-deleted`.')

    with self.argument_context('appconfigdev update', arg_group='Customer Managed Key') as c:
    ...
    with self.argument_context('appconfigdev identity assign') as c:
    ...
    with self.argument_context('appconfigdev identity remove') as c:
        c.argument('identities', arg_type=identities_arg_type, help="Accept system-assigned or user-assigned managed identities separated by spaces. Use '[system]' to refer to system-assigned managed identity, '[all]' for all managed identities or a resource ID to refer user-assigned managed identity. If this argument is not provided or this argument is provided without any value, system-assigned managed identity will be removed by default.")

    with self.argument_context('appconfigdev credential regenerate') as c:
    ...
    with self.argument_context('appconfigdev kv import') as c:
    ...
    with self.argument_context('appconfigdev kv import', arg_group='File') as c:
    ...
    with self.argument_context('appconfigdev kv import', arg_group='AppConfig') as c:
    ...
    with self.argument_context('appconfigdev kv import', arg_group='AppService') as c:
    ...
    with self.argument_context('appconfigdev kv export') as c:
    ...
    with self.argument_context('appconfigdev kv export', arg_group='File') as c:
        c.argument('path', help='Local configuration file path. Required for file arguments.')
    ...
    with self.argument_context('appconfigdev kv export', arg_group='AppConfig') as c:
    ...
    with self.argument_context('appconfigdev kv export', arg_group='AppService') as c:
        c.argument('appservice_account', validator=validate_appservice_name_or_id, help='ARM ID for AppService OR the name of the AppService, assuming it is in the same subscription and resource group as the App Configuration. Required for AppService arguments')
    ...
    with self.argument_context('appconfigdev kv set') as c:
    ...
    with self.argument_context('appconfigdev kv set-keyvault') as c:
        c.argument('key', validator=validate_key, help="Key to be set. Key cannot be a '.' or '..', or contain the '%' character.")
        c.argument('label', help="If no label specified, set the key with null label by default")
        c.argument('tags', arg_type=tags_type)
    ...
    with self.argument_context('appconfigdev kv delete') as c:
    ...
    with self.argument_context('appconfigdev kv show') as c:
    ...
    with self.argument_context('appconfigdev kv list') as c:
    ...
    with self.argument_context('appconfigdev kv restore') as c:
    ...
    with self.argument_context('appconfigdev kv lock') as c:
    ...
    with self.argument_context('appconfigdev kv unlock') as c:
    ...
    with self.argument_context('appconfigdev revision list') as c:
        c.argument('key', help='If no key specified, return all keys by default. Support star sign as filters, for instance abc* means keys with abc as prefix.')
        c.argument('label', help="If no label specified, list all labels. Support star sign as filters, for instance abc* means labels with abc as prefix. Use '\\0' for null label.")

    with self.argument_context('appconfigdev feature') as c:
    ...
    with self.argument_context('appconfigdev feature show') as c:
    ...
    with self.argument_context('appconfigdev feature set') as c:
    ...
    with self.argument_context('appconfigdev feature delete') as c:
    ...
    with self.argument_context('appconfigdev feature list') as c:
    ...
    with self.argument_context('appconfigdev feature lock') as c:
    ...
    with self.argument_context('appconfigdev feature unlock') as c:
    ...
    with self.argument_context('appconfigdev feature enable') as c:
    ...
    with self.argument_context('appconfigdev feature disable') as c:
    ...
    with self.argument_context('appconfigdev feature filter add') as c:
    ...
    with self.argument_context('appconfigdev feature filter update') as c:
    ...
    with self.argument_context('appconfigdev feature filter delete') as c:
    ...
    with self.argument_context('appconfigdev feature filter show') as c:
    ...
    with self.argument_context('appconfigdev feature filter list') as c:
    ...
    with self.argument_context('appconfigdev snapshot show') as c:
        c.argument('snapshot_name', arg_type=snapshot_name_arg_type)
        c.argument('fields', arg_type=snapshot_fields_arg_type)

    with self.argument_context('appconfigdev snapshot list') as c:
    ...
    with self.argument_context('appconfigdev snapshot archive') as c:
        c.argument('snapshot_name', arg_type=snapshot_name_arg_type)

    with self.argument_context('appconfigdev snapshot recover') as c:
        c.argument('snapshot_name', arg_type=snapshot_name_arg_type)
